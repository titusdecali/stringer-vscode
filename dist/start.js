 ...
 */
function findLocalesFolderForOrphanFile(filePath, maxLevelsUp = 5) {
    const absoluteFilePath = path.isAbsolute(filePath) ? filePath : path.resolve(filePath);
    ...
    function decorateEditor(editor) {
        ...
        for (const item of found) {
            ...
            if (effectiveCtx) {
                ...
                const missingLang = activePreviewLanguage && effectiveCtx.availableLanguages.includes(activePreviewLanguage)
